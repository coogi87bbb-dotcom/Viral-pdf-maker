      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <MotionPanel3D tiltX={8} frosted={false}>
          <div className="glass-panel rounded-2xl px-6 py-14 sm:px-16 sm:py-16 text-center space-y-6">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-white text-legible max-w-xl mx-auto">
              Ready to Publish Something That Actually Spreads?
            </h2>
            <p className="text-slate-300 text-legible text-sm sm:text-base max-w-lg mx-auto">
