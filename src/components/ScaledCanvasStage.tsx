...
export const ScaledCanvasStage: React.FC<ScaledCanvasStageProps> = ({
  ...
  return (
    <div className={`flex-1 flex flex-col h-[calc(100vh-210px)] min-h-[660px] max-h-[880px] w-full overflow-hidden bg-slate-950 border border-slate-800/80 rounded-3xl shadow-2xl ${className}`}>
      {/* Control Toolbar Header */}
      <div className="px-3 py-2 bg-slate-900/90 border-b border-slate-800 flex flex-wrap items-center justify-between gap-2 shrink-0 z-10 backdrop-blur-md">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="hidden sm:flex items-center space-x-1 text-[10px] bg-amber-500/10 text-amber-300 border border-amber-500/30 px-2 py-1 rounded-full font-bold">
      ...
      <div
        ref={containerRef}
        className="flex-1 w-full h-full overflow-y-auto overflow-x-auto p-2 sm:p-4 flex justify-center items-start bg-slate-950 relative z-0"
      >
        ...
        {deviceMode === 'mobile' ? (
          ...
          <div className="flex flex-col items-center my-2 space-y-3">
            <div className="text-center flex items-center space-x-2 bg-slate-900/80 px-3 py-1 rounded-full border border-slate-800 text-xs text-slate-300">
              ...
              <span className="text-[10px] text-slate-500">(Scroll inside screen)</span>
            </div>

            {/* Smartphone Device Shell */}
            <div className="w-[375px] h-[720px] bg-slate-900 border-[8px] border-slate-800 rounded-[44px] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.9)] relative flex flex-col overflow-hidden ring-1 ring-slate-700/50">
              {/* Top Speaker / Dynamic Island Notch */}
              <div className="bg-slate-900 pt-2 pb-1 px-6 flex items-center justify-between z-30 shrink-0 text-white select-none">
                ...
                <div className="flex items-center space-x-1 pr-2 text-slate-300">
              ...
              <div className="flex-1 bg-slate-950 overflow-y-auto overflow-x-hidden relative p-2 flex justify-center items-start scrollbar-thin scrollbar-thumb-amber-500/40">
                <div
                  style={{
              ...
              <div className="bg-slate-900 py-1.5 flex justify-center shrink-0 z-30">
          ...
          <div className="flex flex-col items-center my-2 space-y-3">
            ...
            <div className="w-[560px] min-h-[750px] bg-slate-900 border-[10px] border-slate-800 rounded-[32px] shadow-2xl relative flex flex-col overflow-hidden ring-1 ring-slate-700/50 p-3">
              <div className="w-2 h-2 bg-slate-700 rounded-full mx-auto mb-2 shrink-0" />
              <div className="flex-1 bg-slate-950 rounded-2xl overflow-y-auto overflow-x-hidden p-2 flex justify-center items-start">
                <div
                  style={{
                    width: `${Math.round(pageWidth * effectiveScale)}px`,
                    transition: 'width 0.15s ease-out'
