    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-4xl font-black text-white tracking-tight flex items-center gap-3">
              ...
              <span className="text-xs px-2.5 py-0.5 rounded-md bg-gradient-to-r from-emerald-500 to-amber-500 text-slate-950 font-black uppercase">
                10x Precision
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {CALC_PRESETS.map((preset) => (
              <button
                ...
                className={`p-3.5 rounded-2xl border text-left transition-all space-y-1.5 relative ${
              ...
              >
                ...
                <div className="flex items-center justify-between text-[10px] font-mono font-bold pt-1">
                  <span className="text-amber-400">{preset.postsPerWeek} posts/wk</span>
      ...
      {calcMode === 'agency-vs-viralos' && (
        <div className="space-y-6">
          {/* Slider Inputs Grid */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-900/90 p-6 rounded-3xl border border-slate-800 shadow-xl">
            <div className="space-y-2">
              <div className="flex justify-between text-xs font-bold text-slate-300">
                <span>Posts Published / Week:</span>
                <span className="text-amber-400 font-mono text-sm">{postsPerWeek} posts</span>
              </div>
              <input
                type="range"
                min="3"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-6 bg-slate-900/90 rounded-2xl border border-slate-800 space-y-2">
              ...
              <p className="text-xs text-slate-400">Combines saved agency retainer + recovered creator time value.</p>
            </div>

            <div className="p-6 bg-slate-900/90 rounded-2xl border border-emerald-500/40 bg-emerald-950/20 space-y-2">
              ...
              <p className="text-xs text-slate-400">Total capital preserved in your business bank account.</p>
            </div>
            ...
            <div className="p-6 bg-slate-900/90 rounded-2xl border border-slate-800 space-y-2">
              ...
              <p className="text-xs text-slate-400">Equivalent to hiring 1 full-time social media strategist.</p>
            </div>
            ...
            <div className="p-6 bg-slate-900/90 rounded-2xl border border-slate-800 space-y-2">
              ...
              <p className="text-xs text-slate-400">ViralOS pays for its subscription in under 2 days of usage.</p>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-6 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-br from-violet-950/30 via-slate-950 to-slate-950 border border-violet-500/30 space-y-3 flex flex-col justify-between">
              ...
              <div className="text-xs font-mono font-bold text-slate-300 bg-slate-900 p-3 rounded-xl border border-slate-800 flex justify-between">
        ...
        <div className="bg-slate-900/90 p-6 sm:p-8 rounded-3xl border border-slate-800 space-y-6 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2 bg-slate-950 p-4 rounded-2xl border border-slate-800">
              <label className="text-xs font-bold text-slate-300 flex justify-between">
                ...
                <strong className="text-amber-400 font-mono">{monthlyInboundLeads} Leads</strong>
              </label>
              <input
                type="range"
                min="10"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-1">
              <span className="text-[10px] text-slate-400 font-bold uppercase block">Monthly Closed Deals</span>
            ...
            <div className="p-5 rounded-2xl bg-slate-950 border border-amber-500/40 space-y-1">
              <span className="text-[10px] text-amber-400 font-bold uppercase block">Projected ROI Multiplier</span>
              <span className="text-2xl font-black text-amber-300 font-mono">{roiMultiplier}x Net ROI</span>
            </div>
          </div>
        </div>
      )}
                ...
                <button
                  ...
                  className={`p-4 rounded-2xl border text-left transition-all flex items-center justify-between gap-3 ${
                    isSelected
                      ...
                      : 'bg-slate-950/60 border-slate-800/80 opacity-50 hover:opacity-100'
                  }`}
                >
                  <div>
      ...
      <div className="bg-slate-900/90 rounded-3xl border border-slate-800 p-6 sm:p-8 shadow-2xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              {copiedSummary ? <Check className="h-4 w-4 text-emerald-400" /> : <Copy className="h-4 w-4 text-amber-400" />}
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-xs font-bold">
            <span className="text-slate-300">Annual Software & Content Budget Impact:</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-5 rounded-2xl bg-slate-950 border border-emerald-500/40 shadow-xl space-y-3 relative overflow-hidden">
